    ...
    public function index(Request $request)
{
    ...
    $query = DB::table('orders')
        ...
        ->leftJoin('customer_transactions', 'orders.id', '=', 'customer_transactions.order_id') // JOIN TRANSACTIONS TABLE
        ...
        'orders.order_date',
        'orders.total_amount',
        'orders.payment_method',                              // ADDED: orders table payment_method
        'orders.status',
        'customers.name as customer_name',
        'customer_transactions.store as channel',
        'customer_transactions.payment_method as transaction_payment_method',
        'customer_transactions.status as transaction_status',
